...
use crate::cli::flags::{
    ATTACH_FLAGS, BRIGHTNESS_FLAGS, COMPLETIONS_FLAGS, CONTRAST_FLAGS,
    EXTEND_FLAGS, Flag, LAYOUT_FLAGS, LS_FLAGS, MIRROR_FLAGS, ORIENTATIONS,
    PROJECT_FLAGS, SET_FLAGS, SINGLE_FLAGS, SLEEP_FLAGS, TEMP_FLAGS,
    TEMP_PRESETS, TOP_FLAGS, WAKE_FLAGS,
};
